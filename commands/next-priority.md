...
**CRITICAL - Phase and Milestone Boundaries**: DO NOT cross phase or milestone boundaries in a single session. Only work on tasks within the current active phase and milestone. Complete all tasks in the current milestone before moving to the next milestone. Complete all milestones in the current phase before moving to the next phase. This allows for review and course correction between major deliverables. 
